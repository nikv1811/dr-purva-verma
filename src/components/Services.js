    ...
    return (
        <section id="services" className="py-16 px-4 bg-gray-100"> {/* Section ID */}
            <div className="container mx-auto">
                <h2 className="text-4xl font-bold text-center text-gray-800 mb-4">Our Ayurvedic Services in Lake Town, Kolkata</h2> {/* Section Heading */}
                <p className="text-lg text-gray-600 text-center mb-12 max-w-3xl mx-auto">
                    Discover holistic care and personalized treatment plans offered by Dr. Purva Verma, an Ayurvedic Doctor in Lake Town, Kolkata.
                </p>
